  ...
  return (
    <footer className="app-footer">
      <div className="app-footer-links">
        ...
        <span>&middot;</span>
        <a href="https://github.com/buwuhan/buwuhan.github.io" target="_blank" rel="noopener noreferrer">GitHub</a>
      </div>
      <div className="app-footer-copy">
        © 2026 Buwuhan Tracker &mdash; Produk Vibe Code untuk melestarikan tradisi dengan cara modern.
      </div>
    </footer>
  );
}
